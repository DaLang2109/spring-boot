...
@EnableJpaRepositories(
        entityManagerFactoryRef = "secondEntityManager",//配置连接工厂 entityManagerFactory
...
public class JPASecondConfig {
    ...
    @ConfigurationProperties(prefix = "spring.datasource.second") //注意这里
    ...
    @DependsOn("transactionManager")
    public LocalContainerEntityManagerFactoryBean secondEntityManager() throws Throwable {
        ...
        //这里要修改成主数据源的扫描包
        entityManager.setPackagesToScan("com.zhang.dao.test2");
